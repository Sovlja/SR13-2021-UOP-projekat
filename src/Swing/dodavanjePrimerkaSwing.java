...
public class dodavanjePrimerkaSwing extends JDialog {
	...
	private iznajmljivanjeSwing iznajmljivanjeSwing;
	/**
	 * Launch the application.
	 */
	public static void main(String[] args, iznajmljivanjeSwing iznajmljivanjeSwing) {
		try {
			dodavanjePrimerkaSwing dialog = new dodavanjePrimerkaSwing(args, iznajmljivanjeSwing);
	...
	public dodavanjePrimerkaSwing(String [] args, iznajmljivanjeSwing iznajmljivanjeSwing) {
		this.iznajmljivanjeSwing = new iznajmljivanjeSwing();
		this.biblioteka = new Biblioteka();
		setIconImage(Toolkit.getDefaultToolkit().getImage(dodavanjePrimerkaSwing.class.getResource("/images/library-logo.png")));
...
//					if(dialogResult == 0) {
					...
					for (Object item : selectedItems) {
						...
						iznajmljivanjeSwing.imenaPrimeraka.add(item.toString());
					}
					iznajmljivanjeSwing.listaPrimeraka = new JList(listModel);
