...
public class clanoviAdminSwing extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					clanoviAdminSwing  frame = new clanoviAdminSwing ();
	...
	public clanoviAdminSwing () {
		this.biblioteka = new Biblioteka();
		setIconImage(Toolkit.getDefaultToolkit().getImage(clanoviAdminSwing.class.getResource("/images/library-logo.png")));
